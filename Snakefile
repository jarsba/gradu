...
rule generate_parameter_combinations:
    output:
        ...
        expand("data/parameter_combinations/napsu_linear_regression_model_parameters_{linear_regression_dataset_name}_{linear_regression_epsilon_str}e_{linear_regression_repeat_index}_repeat.pickle", zip, linear_regression_dataset_name=linear_regression_dataset_list, linear_regression_epsilon_str=linear_regression_epsilon_list, linear_regression_repeat_index=linear_regression_repeat_index_list)
    log:
        ...
        expand("logs/parameter_combinations_linear_regression_{linear_regression_dataset_name}_{linear_regression_epsilon_str}e_{linear_regression_repeat_index}_repeat.log", zip, linear_regression_dataset_name=linear_regression_dataset_list, linear_regression_epsilon_str=linear_regression_epsilon_list, linear_regression_repeat_index=linear_regression_repeat_index_list)
    threads: 1
    resources:
        runtime="30",
        time="00:30:00",
